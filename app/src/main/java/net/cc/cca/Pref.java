...
import net.cc.cca.timing.work.WorkProviderConstants;
...
public class Pref {
    ...
    public static String getScriptDirPath() {
        ...
        // Android 10+ 使用 StorageUtil 适配分区存储
        return net.cc.cca.tool.StorageUtil.getScriptDirPath(GlobalAppContext.get());
    }
