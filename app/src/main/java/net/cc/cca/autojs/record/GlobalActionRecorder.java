package net.cc.cca.autojs.record;
...
import net.cc.stardust.core.record.Recorder;
import net.cc.stardust.core.record.inputevent.InputEventRecorder;
import net.cc.stardust.core.record.inputevent.InputEventToAutoFileRecorder;
import net.cc.stardust.core.record.inputevent.InputEventToRootAutomatorRecorder;
import net.cc.stardust.core.record.inputevent.TouchRecorder;
