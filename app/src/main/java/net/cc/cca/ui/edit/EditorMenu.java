...
public class EditorMenu {
    ...
    private boolean onDebugOptionsSelected(MenuItem item) {
        int id = item.getItemId();
        if (id == R.id.action_breakpoint) {
            mEditor.addOrRemoveBreakpointAtCurrentLine();
            return true;
        } else if (id == R.id.action_launch_debugger) {
            ...
            mEditorView.debug();
            return true;
        } else if (id == R.id.action_remove_all_breakpoints) {
    ...
    private boolean onJumpOptionsSelected(MenuItem item) {
        int id = item.getItemId();
        if (id == R.id.action_jump_to_line) {
            jumpToLine();
            return true;
        } else if (id == R.id.action_jump_to_start) {
            mEditor.jumpToStart();
            return true;
        } else if (id == R.id.action_jump_to_end) {
            mEditor.jumpToEnd();
            return true;
        } else if (id == R.id.action_jump_to_line_start) {
            mEditor.jumpToLineStart();
            return true;
        } else if (id == R.id.action_jump_to_line_end) {
    ...
    private boolean onMoreOptionsSelected(MenuItem item) {
        ...
        if (id == R.id.action_console) {
            showConsole();
            return true;
        } else if (id == R.id.action_import_java_class) {
            importJavaPackageOrClass();
            return true;
        } else if (id == R.id.action_editor_text_size) {
            mEditorView.selectTextSize();
            return true;
        } else if (id == R.id.action_editor_theme) {
            mEditorView.selectEditorTheme();
            return true;
        } else if (id == R.id.action_open_by_other_apps) {
            openByOtherApps();
            return true;
    ...
    private boolean onEditOptionsSelected(MenuItem item) {
        int id = item.getItemId();
        if (id == R.id.action_find_or_replace) {
            findOrReplace();
            return true;
        } else if (id == R.id.action_copy_all) {
            copyAll();
            return true;
        } else if (id == R.id.action_copy_line) {
            copyLine();
            return true;
        } else if (id == R.id.action_delete_line) {
            deleteLine();
            return true;
        } else if (id == R.id.action_clear) {
            mEditor.setText("");
            return true;
        } else if (id == R.id.action_beautify) {
            beautifyCode();
            return true;
        }
        return false;
