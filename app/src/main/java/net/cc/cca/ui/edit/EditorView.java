...
import net.cc.cca.model.autocomplete.CodeCompletions;
import net.cc.cca.model.autocomplete.Symbols;
...
import net.cc.cca.ui.doc.ManualDialog;
import net.cc.cca.ui.edit.completion.CodeCompletionBar;
import net.cc.cca.ui.edit.debug.DebugBar;
import net.cc.cca.ui.edit.editor.CodeEditor;
import net.cc.cca.ui.edit.keyboard.FunctionsKeyboardHelper;
import net.cc.cca.ui.edit.keyboard.FunctionsKeyboardView;
...
import static net.cc.cca.model.script.Scripts.ACTION_ON_EXECUTION_FINISHED;
import static net.cc.cca.model.script.Scripts.EXTRA_EXCEPTION_COLUMN_NUMBER;
import static net.cc.cca.model.script.Scripts.EXTRA_EXCEPTION_LINE_NUMBER;
import static net.cc.cca.model.script.Scripts.EXTRA_EXCEPTION_MESSAGE;
