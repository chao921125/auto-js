...
public class ExplorerItemList {
    ...
    public static class SortConfig {
        ...
        private static final String CLASS_NAME = "net.cc.cca.ui.viewmodel.ScriptList.SortConfig";
