...
public abstract class AbstractIssueReporterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.cc.cca.R.layout.air_activity_issue_reporter);
        findViews();
    ...
    private void initViews() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(net.cc.cca.R.string.text_issue_report);
        }
    ...
    public void finish() {
        if (mCrash) {
            if (!mReportFailed) {
                Toast.makeText(this, net.cc.cca.R.string.text_report_succeed, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, net.cc.cca.R.string.text_report_fail, Toast.LENGTH_SHORT).show();
            }
            finishAffinity();
        } else {
            super.finish();
