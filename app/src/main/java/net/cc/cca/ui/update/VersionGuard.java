...
import net.cc.cca.R;
import net.cc.cca.network.VersionService;
import net.cc.cca.network.entity.VersionInfo;
...
public class VersionGuard {
    ...
    private void showUpdateInfoIfNeeded(net.cc.cca.network.entity.VersionInfo info) {
