package net.cc.cca.network;

import com.jakewharton.retrofit2.adapter.rxjava2.HttpException;
import net.cc.cca.network.api.UserApi;
import net.cc.cca.network.entity.notification.Notification;
import net.cc.cca.network.entity.notification.NotificationResponse;
