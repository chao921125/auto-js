...
import net.cc.stardust.core.ui.inflater.DynamicLayoutInflater;
import net.cc.stardust.core.ui.inflater.ResourceParser;
import net.cc.stardust.core.ui.inflater.inflaters.CanvasViewInflater;
import net.cc.stardust.core.ui.inflater.inflaters.JsGridViewInflater;
import net.cc.stardust.core.ui.inflater.inflaters.JsImageViewInflater;
import net.cc.stardust.core.ui.inflater.inflaters.JsListViewInflater;
...
import net.cc.stardust.rhino.ProxyObject;
...
public class UI extends ProxyObject {
    ...
    private class Drawables extends net.cc.stardust.core.ui.inflater.util.Drawables {
