package net.cc.stardust.codegeneration;
...
import static net.cc.stardust.codegeneration.CodeGenerator.FIND_ONE;
import static net.cc.stardust.codegeneration.CodeGenerator.UNTIL_FIND;
import static net.cc.stardust.codegeneration.CodeGenerator.WAIT_FOR;
