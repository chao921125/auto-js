package net.cc.stardust.script;
...
import net.cc.stardust.rhino.TokenStream;
...
public abstract class JavaScriptSource extends ScriptSource {
    ...
    public static final String ENGINE = "net.cc.stardust.script.JavaScriptSource.Engine";
