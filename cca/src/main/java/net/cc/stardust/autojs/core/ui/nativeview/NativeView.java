package net.cc.stardust.core.ui.nativeview;
...
import net.cc.stardust.rhino.NativeJavaObjectWithPrototype;
...
public class NativeView extends NativeJavaObjectWithPrototype {
    ...
    public NativeView(Scriptable scope, View view, Class<?> staticType, net.cc.stardust.runtime.ScriptRuntime runtime) {
