...
import net.cc.stardust.inrt.LogActivity
import net.cc.stardust.inrt.Pref
import net.cc.stardust.inrt.R
import net.cc.stardust.inrt.SettingsActivity
...
class AutoJs private constructor(application: Application) : net.cc.stardust.AutoJs(application) {
